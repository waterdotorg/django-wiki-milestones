...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'milestones_milestone', (
            (u'simpleplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wiki.SimplePlugin'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'milestones', ['Milestone'])


    def backwards(self, orm):
        # Deleting model 'Milestone'
        db.delete_table(u'milestones_milestone')
