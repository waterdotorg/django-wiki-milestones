...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Milestone.time'
        db.alter_column(u'milestones_milestone', 'time', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Milestone.time'
        raise RuntimeError("Cannot reverse this migration. 'Milestone.time' and its values cannot be restored.")
    ...
    models = {
        ...
        u'milestones.milestone': {
            'Meta': {'object_name': 'Milestone', '_ormbases': ['wiki.SimplePlugin']},
            'date': ('django.db.models.fields.DateField', [], {}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            u'simpleplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['wiki.SimplePlugin']", 'unique': 'True', 'primary_key': 'True'}),
